...
| 维度 | 规则 |
| --- | --- |
| 画布 | 2.35:1；优先 1880×800、1645×700 或 1410×600 |
| 场景 | 暖木色书房/工作台、木架、窗光、桌面道具 |
| 质感 | 复古像素游戏 UI；人物和真实物品保留真实感 |
| 人物 | 有图 1 时约 80% 真人感 + 20% 像素融合；无图不虚构 |
| 主色 | 深暖木棕、蜂蜜木、奶油米 |
| 强调色 | 紫、桃粉、奶油黄；辅以蓝灰、墨绿、焦糖橙 |
| 明度 | 阳光、暖窗光、奶黄高光；禁止整图阴暗 |

避免全粉、荧光色、冰蓝科技感、黑色赛博感、大面积纯白和细宋体。

## 构图

- 默认：左侧 55%～65% 标题，右侧 30%～40% 真人或留白，下方真实主体。
- 产品型：标题左、产品中、真人右。
- 旅行型：标题中、真实旅行照做路线/Polaroid、真人右。
- 多产品：主标题在上，真实 Logo 或文字名牌横排；每个产品最多一句标签，画面拥挤时删标签。

## 标题

最多三组：小钩子（2～8 字）、主标题（4～10 字）、可选补充。总量约 20～35 个汉字。使用粗方像素字、清晰描边/投影；主标题最大，数字可用玫红或奶油黄强调。

标题应回答“这篇文章为什么值得点开”，不要堆价格、参数、功能清单或受众标签。除非正文明确，否则不要添加“学生党”“大学生”等身份判断。
