...
人物：「秋秋真人参考图」作为面部与身份依据，80% 真人感 + 20% 像素融合，保持黑发、五官比例、口罩与整体气质；不要把人物画成卡通或二次元。（若未提供参考照，此句删除，右侧预留干净背景。）

真实素材（如提供）：「产品 / Logo / 旅行照参考图」按原样放置，不重绘、不换色、不替换品牌，Logo 严格对应。未提供时用文字名或留空。
